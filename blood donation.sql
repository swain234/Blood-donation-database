...
-- Value insertion
INSERT into BB_Manager VALUES (101, 'Abhisek', 9693959671),
    (102, 'Vicky', 9693959672),
    (103, 'Hari', 9693959673),
    (104, 'Elvish', 9693959674),
    (105, 'Mikasa', 9693959675),
    (106, 'Gokul', 9693959676),
    (107, 'Chinmay', 9693959677),
    (108, 'Vivek', 9693959678),
...
-- Value insertion
INSERT into Recording_Staff VALUES (101012, 'Tarun', 4044846553),
    (101112, 'Zen', 4045856553),
    (101212, 'Ranindra', 4045806553),
    (101312, 'Minati', 4045806553),
    (101412, 'Nezuko', 4045806553),
    (101512, 'Muzan', 4045806553),
    (101612, 'Abdul', 4045806553),
    (101712, 'Tina', 4045816553),
    (101812, 'Rahul', 4045826553),
    (101912, 'Gautom', 4045836553);
-- Display table
...
-- Value insertion
INSERT into City VALUES (1100, 'Rourkela'),
    (1200, 'baleshwar'),
    (1300, 'berahmpur'),
    (1400, 'kendujhar'),
    (1500, 'cuttack'),
...
(150011,'Steven',25,'M','O+','2022-07-19',101412,1100),
(150012,'Tony', 35,'M','A-','2022-12-24',101412,1100),
(150013,'Bruce',22,'M','AB+','2022-08-28',101212,1200),
(150014,'Natasha',29,'M','B+','2022-12-17',101212,1300),
(150015,'Hermoine',42,'M','A+','2023-11-22',101212,1300),
(150016,'Harry',44,'F','AB-','2023-02-06',101212,1200),
(150017,'Sherlock',33,'M','B-','2023-10-15',101312,1400),
(150018,'Logan',31,'F','O+','2023-01-04',101312,1200),
(150019,'Peter',24,'F','AB+','2023-09-10',101312,1500),
...
-- Value insertion
INSERT into DiseaseFinder VALUES (11, 'Indiana', 9693959681),
...
-- Value insertion
INSERT into Hospital_Info_1 VALUES (1, 'Springfield', 1100, 101),
